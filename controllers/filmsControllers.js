...
async function getFilms(req, res) {
  try {
    ...
    res.status(500).json({
      ok: false,
      message: 'Something goes wrong on try to get films.'
    })
  }
};
...
async function getFilmById(req, res) {
  ...
  try {
    ...
    res.status(500).json({
      ok: false,
      message: 'Something goes wrong. Cannot get film data.'
    })
  }
...
async function updateFilmById(req, res) {
  ...
  try {
    ...
    res.status(500).json({
      ok: false,
      message: 'Something goes wrong. Cannot update the film.'
    })
  }
}
...
async function updateFilmImage(req, res) {
  ...
  try {
    ...
    res.status(500).json({
      ok: false,
      message: 'Something goes wrong on try to update the film image.'
    })
  }
...
async function deleteFilmById(req, res) {
  ...
  try {
    ...
    res.status(500).json({
      ok: false,
      message: 'Something goes wrong. Cannot delete the film.'
    })
  }

}

async function deleteFilmImage(req, res) {
  const { id } = req.params;
  ...
  try {
    ...
    res.status(500).json({
      ok: false,
      message: 'Something goes wrong. Cannot delete the film image.'
    })
  }
...
module.exports = {
  getFilms, getFilmById, createFilm, updateFilmById, updateFilmImage, deleteFilmById, deleteFilmImage
};